...
import { Info, MapPin, Link as LinkIcon, Eye, Edit, Globe, Lock } from "lucide-react";
...
export default function CardInformation1({
  event,
  editable,
  onEdit,
  linkLabel = "Link",
      ...
      <CardContent className="space-y-6 pt-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className={`space-y-1 ${event.location?.trim().startsWith("<iframe") ? "md:col-span-2" : ""}`}>
              <Label className="text-xs text-muted-foreground uppercase tracking-wider">
